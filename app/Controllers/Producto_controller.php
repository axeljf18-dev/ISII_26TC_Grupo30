...
class Producto_controller extends Controller{
    ...
    public function validarDatosProducto(IncomingRequest $datos){
        ...
        if(!$marcaModel->validarMarca((int) $datos->getVar('marca'))){
            $this->validator->setError('marca', 'La Marca seleccionada no es válida.');
            $valido = false;
        }

        if(!$categoriaModel->validarCategoria((int) $datos->getVar('categoria'))){
            $this->validator->setError('categoria', 'La Categoría seleccionada no es válida.');
            $valido = false;
        }

        if(!$proveedorModel->validarProveedor((int) $datos->getVar('proveedor'))){
